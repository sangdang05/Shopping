...
class DuplicateOptions
{
    ...
    /**
     * Set the $excludedColumns to work with in the \Traits\HasDuplicates trait.
     *
    ...
    /**
     * Set the $uniqueColumns to work with in the \Traits\HasDuplicates trait.
     *
     * @param array|string $columns
     * @return DuplicateOptions
     */
    ...
    /**
     * Set the $excludedRelations to work with in the \Traits\HasDuplicates trait.
     *
    ...
    /**
     * Set the $excludedRelationColumns to work with in the \Traits\HasDuplicates trait.
     *
     * Param $columns:
    ...
    /**
     * Set the $uniqueRelationColumns to work with in the \Traits\HasDuplicates trait.
     *
     * Param $columns:
    ...
    /**
     * Set the $shouldDuplicateDeeply to work with in the \Traits\HasDuplicates trait.
     *
     * @return DuplicateOptions
     */
