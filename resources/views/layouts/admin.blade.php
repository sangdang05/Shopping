...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="{{url('public/site')}}/images/icons/favicon.png">
  <link rel="icon" type="image/png" href="{{url('public/site')}}/images/icons/favicon.png"/>
  <title>
   Dashboard
  </title>
  <!--     Fonts and icons     -->
  ...
  <!-- Nucleo Icons -->
  <link href="{{url('siteadmin')}}/css/nucleo-icons.css" rel="stylesheet" />
  <link href="{{url('siteadmin')}}/css/nucleo-svg.css" rel="stylesheet" />
  <!-- Font Awesome Icons -->
...
<body class="g-sidenav-show  bg-gray-200">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0  my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0 d-flex justify-content-center" href="{{route('home.index')}}" target="_blank">
        ...
        <img src="{{url('public/site')}}/images/icons/logo-2.png" alt="IMG-LOGO">
      </a>
    </div>
              ...
              <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="{{url('siteadmin')}}/img/team-2.jpg" class="avatar avatar-sm  me-3 ">
                      </div>
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="{{url('siteadmin')}}/img/small-logos/logo-spotify.svg" class="avatar avatar-sm bg-gradient-dark  me-3 ">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="" class="font-weight-bold" target="_blank">songvedem</a>
              </div>
            </div>
  ...
  <!--   Core JS Files   -->
  <script src="{{url('siteadmin')}}/js/core/popper.min.js"></script>
  <script src="{{url('siteadmin')}}/js/jquery.js"></script>
  <script src="{{url('siteadmin')}}/js/core/bootstrap.min.js"></script>
  <script src="{{url('siteadmin')}}/js/plugins/perfect-scrollbar.min.js"></script>
  <script src="{{url('siteadmin')}}/js/plugins/smooth-scrollbar.min.js"></script>
  <script src="{{url('siteadmin')}}/js/plugins/chartjs.min.js"></script>
  @yield('js')
  <script>
