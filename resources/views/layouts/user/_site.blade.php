...
<!--===============================================================================================-->
	<link rel="stylesheet" type="text/css" href="{{url('site')}}/fonts/iconic/css/material-design-iconic-font.min.css">
<!--===============================================================================================-->
	...
	<header>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="{{url('site')}}/index.html"><img src="{{url('site')}}/images/icons/logo-01.png" alt="IMG-LOGO"></a>
			</div>
			...
			<div class="header-cart-content flex-w js-pscroll">
				<ul class="header-cart-wrapitem w-full">
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{url('site')}}/images/item-cart-01.jpg" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{url('site')}}/images/item-cart-02.jpg" alt="IMG">
						</div>
					...
					<li class="header-cart-item flex-w flex-t m-b-12">
						<div class="header-cart-item-img">
							<img src="{{url('site')}}/images/item-cart-03.jpg" alt="IMG">
						</div>
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						<a href="{{url('site')}}/shoping-cart.html" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
							Xem Giỏ Hàng
						</a>

						<a href="{{url('site')}}/shoping-cart.html" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
							Check Out
						</a>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					Nếu có bất cứ câu hỏi nào? Hãy  liên hệ với chúng tôi tại cửa hàng tại Tay Nguyen University, Buon Ma Thuot, Dak Lak hoặc gọi cho chúng tôi theo số (+1) 96
					</p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a class="creator-info" href="https://www.facebook.com/iamrockleee" target="_blank">songvedem</a></a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<img src="{{url('site')}}/images/icons/icon-close.png" alt="CLOSE">
				</button>
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="{{url('site')}}/images/product-detail-01.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{url('site')}}/images/product-detail-01.jpg">
									...
									<div class="item-slick3" data-thumb="images/product-detail-02.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="{{url('site')}}/images/product-detail-02.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{url('site')}}/images/product-detail-02.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
									...
									<div class="item-slick3" data-thumb="images/product-detail-03.jpg">
										<div class="wrap-pic-w pos-relative">
											<img src="{{url('site')}}/images/product-detail-03.jpg" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{url('site')}}/images/product-detail-03.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
	...
	<script>
		...
		$('.js-addwish-b2').each(function(){
			...
			$(this).on('click', function(){
				swal(nameProduct, "đã thêm và danh sách yêu thích !", "success");
